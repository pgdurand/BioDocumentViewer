 ...
 * EBI-eye expressions that will target nucleotide databanks. E.g. ENA Sequence.
 * 
 * @author Patrick G. Durand
 */
public class NucleotideQueryModel extends EbiQueryModel {

	public NucleotideQueryModel() {
		super();
	}

	public Enumeration<String> getAccessorVisibleNames() {
		return getAccessorVisibleNames("N");
	}
