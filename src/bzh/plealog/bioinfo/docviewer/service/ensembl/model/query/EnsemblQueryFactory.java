...
/**
 * This is an implementation of interface BFilterFactory to create Ensembl
 * filters.
 * 
 * @author Patrick G. Durand
 */
public class EnsemblQueryFactory implements BFilterFactory {

  // this is for special use: provide directly an Ensembl entrypoint. Yet to be
  // implemented...
  ...
  public BFilter createFilter(BOperatorAccessors fModel, String filterName) throws BFilterException {
    ...
    if (filterName.equals(QUERY_IS_AN_ENTREZ_EXPRESSION)) {
      ...
      return new EnsemblQueryExpressionBuilder((EnsemblQueryModel) fModel, filterName);
    }
  }
  ...
  public BFilter createFilter(BOperatorAccessors fModel, BFilterIO filter) throws BFilterException {
    ...
    return new EnsemblQueryExpressionBuilder((EnsemblQueryModel) fModel, filter);
  }
}
